...
const moreProjects = [
  ...
  {
    title: "Mosaic Me",
    type: "Extended Open-Source Fork",
    description:
      "Forked from Jonathan Tiedchen's Mosaic Me and extended with perceptual Lab color matching, light image preprocessing, improved Streamlit session handling, and consolidated download tracking.",
    image:
    ...
    upstreamUrl: "https://github.com/jonathantiedchen/mosaic-me",
  },
  {
    ...
    >
      ...
      <div className="portfolio-project-copy">
        ...
        <div className="project-actions">
          ...
          {project.upstreamUrl ? (
            <a href={project.upstreamUrl} target="_blank" rel="noopener noreferrer">
              Original project <span aria-hidden="true">↗</span>
            </a>
          ) : null}
